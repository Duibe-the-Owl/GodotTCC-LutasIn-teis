...
func start_dialogue():
	...
	if current_scene_name == "prédiotrabalhoNoite2":
		Dialogic.start("PortariaNight2") 
		
	elif current_scene_name == "prédiotrabalhoNoite3":
		Dialogic.start("PortariaNight3")
		
	else:
		Dialogic.start("PortariaNight")
